...
const CInterfaceProxyVtbl * _unDonut_ProxyVtblList[] =
{
...
const CInterfaceStubVtbl * _unDonut_StubVtblList[] =
{
	( CInterfaceStubVtbl *) &_IAPI4StubVtbl,
	( CInterfaceStubVtbl *) &_IAPI3StubVtbl,
	( CInterfaceStubVtbl *) &_IAPI2StubVtbl,
...
PCInterfaceName const _unDonut_InterfaceNamesList[] =
{
	"IAPI4",
	"IAPI3",
	"IAPI2",
...
const IID *  _unDonut_BaseIIDList[] =
{
	&IID_IDispatch,
	&IID_IDispatch,
	&IID_IDispatch,
...
#define _unDonut_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _unDonut, pIID, n)

int __stdcall _unDonut_IID_Lookup( const IID * pIID, int * pIndex )
{
	IID_BS_LOOKUP_SETUP

	IID_BS_LOOKUP_INITIAL_TEST( _unDonut, 4, 2 )
	IID_BS_LOOKUP_NEXT_TEST( _unDonut, 1 )
	IID_BS_LOOKUP_RETURN_RESULT( _unDonut, 4, *pIndex )

}

const ExtendedProxyFileInfo unDonut_ProxyFileInfo =
{
	(PCInterfaceProxyVtblList *) & _unDonut_ProxyVtblList,
	(PCInterfaceStubVtblList *) & _unDonut_StubVtblList,
	(const PCInterfaceName * ) & _unDonut_InterfaceNamesList,
	(const IID ** ) & _unDonut_BaseIIDList,
	& _unDonut_IID_Lookup,
	4,
	2,
